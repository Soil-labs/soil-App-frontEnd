          ...
          <section className="col-span-3 border-2 bg-white border-gray-100 rounded-lg p-8">
            ...
            <div className="grid grid-cols-8 pb-2 pt-4 gap-x-5 gap-y-2">
              ...
              <section className="col-span-3">
                <ul className="flex flex-wrap gap-2">
                  <SkillTag variant="matching">Backend Development</SkillTag>
                  <SkillTag variant="matching">MERN Stack</SkillTag>
                  <SkillTag variant="matching">Team Collaboration</SkillTag>
                </ul>
              </section>
              <section className="col-span-3">
                <ul className="flex flex-wrap gap-2">
                  <SkillTag variant="missing">Missing Skill 1</SkillTag>
                  <SkillTag variant="missing">Missing Skill 2</SkillTag>
                  <SkillTag variant="missing">Another Missing skill</SkillTag>
                  <SkillTag variant="missing">Skill Issue</SkillTag>
                </ul>
              </section>
            ...
            <section className="pt-4 ">
              ...
              <p className="text-gray-500">
                As an SDN Backend Developer, you will apply your deep expertise
                to design, develop, automate and test NFV/SDN
                components/features and its associated life cycle operations
                across various supported virtual infrastructure manager(VIM)
                stacks using test-driven development approachResolve customer
                issues with a mixture of business acumen and technical
                competenceFamiliarity with Shell scripting, Linux Commands and
            ...
            <form className="pt-4">
              ...
              <div className="flex justify-center gap-4 py-8">
                ...
                <button className="px-4 py-2 bg-[#4164DF] rounded-lg text-white flex gap-2 items-center">
                  Apply Now
                  <ChevronRightIcon width={16} className="" />
                </button>
              </div>
            </form>
          </section>
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2 py-4">
                  <div className="w-8 rounded-full overflow-hidden">
                    <Image src={placeholder_avatar} alt="placeholder avatar" />
                  </div>
                ...
                <p className="text-gray-400 py-4 s">
                  Find & be found for opportunities across the DAO. Find & be
                  found for opportunities across the DAO.
                </p>
              </div>
